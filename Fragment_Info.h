...
public:
	...
	vector<unsigned int> SS_A_R1;
	vector<unsigned int> SS_B_R1;
	unsigned int counter_A_R1;
	unsigned int counter_B_R1;
	vector<unsigned int> SS_A_C1;
	vector<unsigned int> SS_B_C1;
	unsigned int counter_A_C1;
	unsigned int counter_B_C1;
	vector<unsigned int> SS_A_R2;
	vector<unsigned int> SS_B_R2;
	unsigned int counter_A_R2;
	unsigned int counter_B_R2;
	vector<unsigned int> SS_A_C2;
	vector<unsigned int> SS_B_C2;
	unsigned int counter_A_C2;
	unsigned int counter_B_C2;
	Fragment_Info();
	~Fragment_Info() {}; // deconstructor
	friend ostream & operator<<(ostream & os, const Fragment_Info & M);
};
...
ostream & operator<<(ostream & os, const Fragment_Info & M) {
